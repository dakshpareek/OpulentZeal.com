 ...
 <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
        	['Browser', 'Visits'],
             <?php 
	        	$query = "SELECT count(id) AS count, Pub FROM alldet Where Adv='$spl' AND Date='$spdate' GROUP BY Pub";

	        	$exec = mysqli_query($con,$query);
	        	while($row = mysqli_fetch_array($exec)){

	        		echo "['".$row['Pub']."',".$row['count']."],";
	        	}
	   ?>
        ]);
 ...
 <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Advertiser</b></a>
            <!--logo end-->
...
?>
          <h3></h3>
              ...
              <div class="tab-pane" id="chartjs">
                  <div class="row mt">
									<div align="left">
									<h4 align="center">These Are The Publisher Who Provides You Traffic on Your Selected Campaign</h4>
									<h4 align="center"><b>Note:</b>Select Date From Upper Drop Down To Get Result Of Perticular Date.</h4>

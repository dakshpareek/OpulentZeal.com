    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
        	['Browser', 'Visits'],
             <?php 
	        	$query = "SELECT count(Adv) AS count, Adv FROM alldet where Pub='$site' GROUP BY Adv";
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a  href="index.php">Advertiser</a></li>
      ...
      <section id="main-content">
          ...
          <h3></h3>
              ...
              <div class="tab-pane" id="chartjs">
                  ...
                  <div class="row mt">
                      <div align="left">
									<h4 align="center">These Are The Advertisers Who Are Generating Good Relavent Audience By Help of Your Website.</h4>
									<h4 align="center"><b>Note:</b>This is Total Amount of Traffic Given By You.</h4>
